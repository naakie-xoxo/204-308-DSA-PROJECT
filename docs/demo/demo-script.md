...
- Generate the local SQLite database with:

  ```powershell
  mvn --batch-mode --no-transfer-progress compile exec:java "-Dexec.mainClass=ug.edu.ugmc.optimizer.database.DatabaseManager"
